...
{
    public function test_uuid_class_is_available(): void
    {
    ...
    public function test_uuid_generation_methods(): void
    {
    ...
    public function test_shorthand_methods(): void
    {
    ...
    public function test_uuid_properties(): void
    {
    ...
    public function test_nil_uuid(): void
    {
    ...
    public function test_modern_uuid_versions(): void
    {
